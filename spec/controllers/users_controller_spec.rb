...
RSpec.describe UsersController, type: :controller do
  ...
  before(:all) do
     @user = User.create(username: "ahmad", email: "mariam41@gmail.com", password: "abc123")
     @unauthorized_user = User.create(username: "mahmod", email: "parami41@gmail.com", password: "xyz123")
   end
...
describe "create user" do
  it "should create new user" do
    ...
    expect(flash[:success]).to eql("You've registred.")
  end
end
#
